...
class AuthControllerTest {
    ...
    void register_validBody_returns201WithTokens() throws Exception {
        ...
        when(authService.register(any(RegisterRequest.class)))
                .thenReturn(new AuthResponse("jwt.access", "raw-refresh", 900, "alice", Role.CUSTOMER));
    ...
    void login_validBody_returns200WithTokens() throws Exception {
        ...
        when(authService.login(any(LoginRequest.class)))
                .thenReturn(new AuthResponse("jwt.access", "raw-refresh", 900, "operator", Role.OPERATOR));
    ...
    void refresh_validBody_returns200() throws Exception {
        ...
        when(authService.refresh(anyString()))
                .thenReturn(new AuthResponse("new.jwt", "new-raw", 900, "alice", Role.CUSTOMER));
